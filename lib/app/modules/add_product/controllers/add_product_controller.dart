...
import 'package:uas_21312065/app/modules/add_product/controllers/add_product_controller.dart';
...
class AddMahasiswaController extends GetxController {
  ...
  void addMahasiswa(String npm, String nama, String alamat) async {
    CollectionReference mahasiswa = firestore.collection("mahasiswa_21312065");
    try {
      await mahasiswa.add({
        "npm": npm,
        "nama": nama,
