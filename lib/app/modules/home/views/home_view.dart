...
import 'package:uas_21312065/app/controllers/auth_controller.dart';
import 'package:uas_21312065/app/routes/app_pages.dart';
...
class HomeView extends GetView<HomeController> {
  ...
  stream: FirebaseFirestore.instance.collection('mahasiswa_21312065').snapshots(),
  builder: (context, snapshot) {
